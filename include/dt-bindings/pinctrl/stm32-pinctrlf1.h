...
#define STM32_PIN_FSMC_LCD_BACKLIGHT_LED	(STM32_MODE_OUTPUT | STM32_CNF_PUSH_PULL | STM32_MODE_OUTPUT_MAX_50)
#define STM32_PIN_FSMC_LCD			(STM32_MODE_OUTPUT | STM32_CNF_ALT_FUNC | STM32_CNF_PUSH_PULL | STM32_MODE_OUTPUT_MAX_50)
