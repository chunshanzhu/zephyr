...
#define STM32_PIN_SPI		(STM32_MODE_OUTPUT | STM32_CNF_ALT_FUNC | STM32_CNF_PUSH_PULL | STM32_PUPD_PULL_UP | STM32_MODE_OUTPUT_MAX_50)
#define STM32_PIN_ADC           (STM32_MODE_INPUT  | STM32_CNF_IN_ANALOG | STM32_PUPD_NO_PULL)
